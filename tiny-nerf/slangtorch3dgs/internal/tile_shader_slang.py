...
import torch
from . import slang
from .slang import slang_modules as slang_modules
import math
from .sort_by_keys import sort_by_keys_torch
...
def vertex_and_tile_shader(xyz_ws,
    ...
    with torch.no_grad():
      ...
      sorted_keys, sorted_gauss_idx = sort_by_keys_torch.sort_by_keys_torch(unsorted_keys, unsorted_gauss_idx)
