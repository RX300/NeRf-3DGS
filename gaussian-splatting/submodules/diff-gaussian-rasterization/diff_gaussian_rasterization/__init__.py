...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        num_rendered, color, radii, geomBuffer, binningBuffer, imgBuffer, invdepths,means2D,meansHomo,conic_opacity = _C.rasterize_gaussians(*args)
        ...
        return color, radii, invdepths,means2D,meansHomo,conic_opacity
